...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortin_saldo_ei_muutu_kun_ladataan_negatiivinen_summa(self):
        self.kortti.lataa_rahaa(-10)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_saldo_vain_yhdelle_edulliselle(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
    ...
    def test_saldo_vain_yhdelle_maukkaalle(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
